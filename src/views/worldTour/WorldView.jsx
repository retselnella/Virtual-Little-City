      ...
      {mapTab === 'island' ? <div className="island-map" role="tabpanel">
        ...
        <aside>
          ...
          <ul className="map-legend">
            <li><i style={{ background: '#fff' }} />You</li><li><i style={{ background: '#64ddd1' }} />Your car</li><li><i style={{ background: '#87c7a1' }} />City Hub (spawn)</li>
            <li><i style={{ background: '#f8d47a' }} />Objective</li><li><i style={{ background: '#ffa860' }} />Lighthouse</li><li><i style={{ background: '#b88a5c', borderRadius: 2 }} />Cabins</li><li><i style={{ background: '#ff9a3c' }} />Campsite</li><li><i style={{ background: '#2f4b37' }} />Forest · <i style={{ background: '#2f7486' }} />lake</li><li><i style={{ background: '#f8f1a8' }} />Other players</li><li><i style={{ background: '#ff6d82' }} />Gang · <i style={{ background: '#88aaff' }} />police</li>
          </ul>
          <p className="island-tip">Everyone starts at the City Hub. Take the Ring Road out to the beaches, the farmland, the forests and their cabins, Mirror Lake and its campsite, the Lighthouse Cape and the foot of Mount Alon. The south hills are gentle enough to climb.</p>
        </aside>
