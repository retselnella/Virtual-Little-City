...
export function useWorldInput(paused, action, setPanel) {
  ...
  useEffect(() => {
    ...
    function down(e) {
      ...
      const key = { KeyF: 'vehicle', KeyE: 'interact', KeyQ: 'weapon', KeyR: 'reload', KeyJ: 'attack', KeyV: 'minimap', Digit1: 'slot1', Digit2: 'slot2', Digit3: 'slot3', Digit4: 'slot4', Digit5: 'slot5' }[e.code]; if (key) actions.current(key);
