...
import { MAX_STARS, escapeTime, helicoptersFor, recordKill, starsOf, unitsFor } from '../../src/models/worldTour/wanted.js';
...
test('killing people raises the wanted level up to five stars', () => {
  ...
  assert.deepEqual([1, 2, 3, 4, 5].map(helicoptersFor), [0, 0, 0, 1, 2], 'helicopters at four and five stars');
